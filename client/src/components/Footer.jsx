        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-6">
              Where Innovation Meets Imagination. Join us for the biggest tech expo featuring cutting-edge technology and unforgettable experiences.
            </p>
            
            {/* Social Icons */}
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-white/5 hover:bg-cyan-500 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300">
          ...
          <div className="col-span-1">
            <h4 className="text-white font-semibold text-lg mb-5">Our Events</h4>
            <ul className="space-y-3">
              {events.map((event) => (
                <li key={event}>
                  <Link
          ...
          <div className="hidden md:block lg:col-span-1">
            ...
            <div className="space-y-4">
              <a href="mailto:events@gvpce.edu" className="flex items-center gap-3 text-gray-500 hover:text-cyan-400 transition-colors duration-300 group">
                ...
                <span className="text-sm">events@gvpce.edu</span>
              </a>
              <a href="tel:+919876543210" className="flex items-center gap-3 text-gray-500 hover:text-cyan-400 transition-colors duration-300 group">
                <div className="w-10 h-10 bg-white/5 group-hover:bg-cyan-500/10 rounded-lg flex items-center justify-center transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            <p className="text-gray-600 text-sm">
              © {currentYear} GVPCE Tech Expo. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <a href="#" className="text-gray-600 hover:text-cyan-400 text-sm transition-colors">Privacy Policy</a>
              <a href="#" className="text-gray-600 hover:text-cyan-400 text-sm transition-colors">Terms of Service</a>
            </div>
          </div>
        </div>
      </div>

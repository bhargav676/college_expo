...
const Home = () => {
  ...
  return (
    <PageLayout>
      ...
      {/* 
          MODIFIED WRAPPER: 
          Changed min-h-screen to min-h-[85vh] on mobile to reduce the gap.
          Added pt-32 and pb-10 on mobile to handle spacing properly.
          Kept md:min-h-screen and md:pt-0 for perfect desktop centering.
      */}
      <div className="relative min-h-[85vh] md:min-h-screen w-full flex items-center justify-center overflow-hidden pt-32  md:pt-0 md:pb-0">
        ...
        {/* BACKGROUND LAYER 1: Triple Orbs (Original Logic) */}
        ...
        <div className="relative z-10 text-center px-0 max-w-5xl mx-auto">
          ...
          >
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white mb-2 italic uppercase">
              TECH<span className="text-transparent stroke-text">EXPO</span>
            </h1>
            
            <div className="flex items-center justify-center gap-4 mb-10">
              <div className="h-[1px] w-12 md:w-24 bg-gradient-to-r from-transparent to-cyan-500" />
              <span className="text-2xl md:text-5xl font-light text-cyan-500 tracking-[0.4em] font-mono">2K26</span>
          ...
          <motion.div
            ...
            className="text-xl md:text-3xl text-gray-300 font-light mb-8 h-8"
          >
          ...
          <motion.p
            ...
            className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto mb-10 leading-relaxed font-light"
          >
